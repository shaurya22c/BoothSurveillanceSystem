                        ...
                        <div id="widget_visitor" class="widget_card alert">
                           ...
                           <div class="widget_card_body">
                              ...
                              <div class="widget_text">
                                 <h3 class="count">${totalcomplaintList}</h3>
                     ...
                     <div class="col-md-3">
                        <div id="widget_user" class="widget_card alert">
                           ...
                           <div class="widget_card_body">
                              ...
                              <div class="widget_text">
                                 <h3 class="count">${pendingcomplaintList}</h3>
                     ...
                     <div class="col-md-3">
                        <div id="widget_profits" class="widget_card alert">
                           ...
                           <div class="widget_card_body">
                              ...
                              <div class="widget_text">
                                 <h3 class="count">${feedbackList}</h3>
                                 <p>Total Feedbacks</p>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-12">
                        <div class="widget_card_two alert">
                           ...
                           <img src= "<%=request.getContextPath()%>/adminResources/image/Figure_1.png"/>
                        </div>
                     </div>
                     <!-- End Col -->
                  </div>
                        ...
                        <div class="widget_card_two alert">
                           ...
                           <div class="widget_card_body collapse in" id="Campaign">
                              <div class="progress-list">
                                 ...
                                 <img src= "<%=request.getContextPath()%>/adminResources/image/plot.png" style= "height:1000px;width:1000px"/>
                              </div>
                           </div>
                        </div>
                        <!-- <div class="widget_card_two alert">
