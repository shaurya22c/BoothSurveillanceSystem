...
function fn1()
	{
		...
		//alert(file)
		//var inputNode = file.value.replace("C:\\fakepath\\", "");
		var inputNode=[];
	...
	//htp.open("get","http://48843f1f.ngrok.io/?imageName="+inputNode,true);
	htp.send();
}
...
//htp.open("get","http://48843f1f.ngrok.io/peoplecounter",true);
htp.open("get","http://127.0.0.1:5000/peoplecounter",true);
htp.send();
}
                     ...
                     <div class="col-md-12">
                        <div class="page-box">
                           <div class="form-example">
                              <h3 align="center">Start Surveillance</h3>
                              <div class="form-validation-box">
                                 <div class="form-wrap">
                                 <%@taglib prefix="f" uri="http://www.springframework.org/tags/form" %>
                                 
                                    <input type="file" id="fileName" value="Choose File" enctype="multipart/form-data" multiple><br>
	<input type="button" value="Detection" onclick="fn1()" class="btn btn-success">
	<input type="button" value="lineCross" onclick="fn2()" class="btn btn-success">
	<div id="d1"></div>
                                 </div>
                              </div>
                           </div>
