               ...
               <div class="container-fluid">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                              ...
                              <div class="form-validation-box">
                                 <div class="form-wrap">
                                  <%@taglib prefix="f" uri="http://www.springframework.org/tags/form" %>
                                     ...
                                     <f:form class="Feedbackfm" action="insertRaiting" method="post" modelAttribute="feedbackVO">                                                         

                                                            <div class="form-group">
                                                                <label>Feedback</label>
                                                                <div>
                                                                    <f:textarea path="feedBack" required="required" class="form-control" rows="5"></f:textarea>
                                                                    <f:hidden path="id"/>
                                                                </div>
                                                            </div>
					    ...
					    <f:radiobutton class="star star-5" id="star-5"  path="rating" value= "5" required= "required"/>
					    <label class="star star-5" for="star-5"></label>
					    <f:radiobutton class="star star-5" id="star-4" path="rating" value= "4" required= "required"/>
					    <label class="star star-4" for="star-4"></label>
					    <f:radiobutton class="star star-5" id="star-3" path="rating" value= "3" required= "required"/>
					    <label class="star star-3" for="star-3"></label>
					    <f:radiobutton class="star star-5" id="star-2"  path="rating" value= "2" required= "required"/>
					    <label class="star star-2" for="star-2"></label>
					    <f:radiobutton class="star star-5" id="star-1" path="rating" value= "1" required= "required"/>
