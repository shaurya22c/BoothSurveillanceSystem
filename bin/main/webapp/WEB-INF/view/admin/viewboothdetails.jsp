                           ...
                           <div class="advance-table">
                              <table id="responsive_datatables_example" class="table display table-striped table-bordered responsive nowrap">
                                 ...
                                 <c:forEach items= "${k}" var= "z">
                                    <tr>
                                       <td>${z.boothId}</td>
                                       <td>${z.boothAddress}</td>
                                       <td>${z.boothNo}</td>
                                       <td>${z.requiredPerson}</td>
                                       <td>${z.areaVO.areaId}</td>
                                       <td>${z.cityVO.cityId}</td>
                                       
                                        <!--<td>${z.cityVO.cityName}</td>-->
										<td><a href= "editBooth?id1=${z.boothId}">Edit</a></td>
										<td><a href="deleteBooth?id1=${z.boothId}">Delete</a></td>
