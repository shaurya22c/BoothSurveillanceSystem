                           ...
                           <div class="form-example">
                              ...
                              <div class="form-validation-box">
                                ...
                                <%@taglib prefix= "f" uri= "http://www.springframework.org/tags/form" %>
                     		    <f:form action= "insertStaff" modelAttribute="staffVO" method="post" enctype= "multipart/form-data">			
                                <div class="row">
                                <div class="col-md-6">
                                <div class="form-group">
                                <label class= "control-label">First Name</label>
                     			<f:input path= "firstName"  placeholder="Firstname" class="form-control" required= "required"/>
                     			</div>
								</div>
								</div>
                                ...
                                <label class= "control-label">Last Name</label>
                     			<f:input path= "lastName"  placeholder="Lastname" class="form-control" required= "required"/>
                     			</div>
								</div>
								</div>
                                ...
                                <label class= "control-label">Email</label>
                     			<f:input path="loginVO.username" placeholder="email" class="form-control" required= "required"/>
                     			</div>
								</div>
								</div>
                                ...
                                <label class= "control-label">Password</label>
                     			<f:input type= "password" path="loginVO.password" placeholder="password" class="form-control" required= "required"/>
                     			</div>
								</div>
								</div>
                                ...
                                <label class= "control-label">Photo</label>
                     			<input type= "file" name= "file" placeholder= "photo" class= "form-control" enctype= "multipart/form-data" required= "required">
                     			</div>
								</div>
								</div>
                                ...
                                <label class= "control-label">City Name</label>
                     			<f:input path="cityName" placeholder="cityname" class="form-control" required= "required"/>
                     			</div>
								</div>
								</div>
                                ...
                                <label class= "control-label">Area Name</label>
                     			<f:input path="areaName" placeholder="areaName" class="form-control" required= "required"/>
                     			</div>
								</div>
								</div>
                                ...
                                <label class= "control-label">Address</label>
                     			<f:textarea path="address" placeholder="address" class="form-control" required= "required"/>
                     			</div>
								</div>
								</div>
                                ...
                                <label class= "control-label">Mobile Number</label>
                     			<f:input path="number" placeholder="mobileNumber" class="form-control" required= "required"/>
                     			</div>
								</div>
								</div>
