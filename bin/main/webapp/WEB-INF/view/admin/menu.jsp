...
<nav id="sidebar">
               ...
               <div class="sidebar-profile clearfix">
                  <div class="profile-avatar">
                     ...
                     <!--<img src="<%=request.getContextPath()%>/adminResources/image/shaurya.jpg" alt="profile" />--> 
                  </div>
                  <div class="profile-info">
                     <h3>${sessionScope.fname}</h3>
                     <p>Welcome ${sessionScope.fname} !</p>
                     <!--<h3>Shaurya Bavishi</h3>
                     <p>Welcome Admin !</p>-->
                  </div>
               </div>
               <!-- Sidebar Profile End -->
               ...
               <div class="menu-section">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                       ...
                       Manage Booth
                        ...
                        <ul class="collapse list-unstyled" id="boothdetails">
                           ...
                           <li><a href="loadBooth">Add BoothDetails</a></li>
                      ...
                      <li>
                        ...
                        <ul class="collapse list-unstyled" id="AllocateStaff">
                     ...
                     <!--<li>
                       ...
                       <li>
                        <a href="#surveillance" data-toggle="collapse" aria-expanded="false">
                        <!--<i class="fa fa-th"></i>-->
                        <img src= "<%=request.getContextPath()%>/adminResources/image/icons8-facial-recognition-filled-50.png">
                        Surveillance
                        </a>
                        <ul class="collapse list-unstyled" id="surveillance">
                           <li><a href="viewDetectionFinal">Start Surveillance</a></li>
                           <!--<li><a href="notes.html">View Report</a></li>-->
