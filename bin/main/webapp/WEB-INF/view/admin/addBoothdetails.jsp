   ...
   <body>
      ...
      <div class="wrapper">
         ...
         <header class="main-header">
            ...
            <!-- Header Top Start -->
              <jsp:include page="header.jsp"></jsp:include>  <!-- Header Top End -->
         ...
         <aside class="seipkon-main-sidebar">
             <jsp:include page="menu.jsp"></jsp:include>         </aside>
         <!-- End Sidebar -->
                           ...
                           <div class="form-example">
                              ...
                              <div class="form-validation-box">
                                 ...
                                 <%@taglib prefix= "f" uri= "http://www.springframework.org/tags/form" %>
                                    <f:form action="insertBooth" modelAttribute="boothVO" method= "post">
                                    
                                       <div class="row">
                                       <div class="col-md-6">
                                             <div class="form-group">
                                             <label class="control-label">Add Booth No:</label>
                                           <f:input path="boothNo" placeholder="boothNo" class="form-control" required= "required" />
											</div>
										</div>
										</div>
										<div class="row">
                                          <div class="col-md-6">
                                             <div class="form-group">
                                             	<label class="control-label">Number of Required Person:</label>
                                               <f:input path="requiredPerson" placeholder="Required Person" class="form-control" required="required"/>
                                             </div>
                                          </div>
                                          </div>
                                          <div class="row">
                                          <div class="col-md-6">
                                            ...
                                            <label class="control-label">Cityname:</label>
                     						<f:select path="CityVO.cityId" class= "form-control" onchange= "getarea()" id= "cityid">
                                          ...
                                          <div class="col-md-6">
                                             ...
                                             <f:select path="AreaVO.areaId" class= "form-control" id= "areaid">
                                          ...
                                          <div class="col-md-6">
                                             ...
                                             <label class="control-label">Address:</label>
                                                <f:textarea rows="5" cols="5" path= "boothAddress" placeholder="Address" class="form-control" required= "required" ></f:textarea>
                                             </div>
                                          </div>
