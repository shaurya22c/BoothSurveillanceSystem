                           ...
                           <div class="form-example">
                              ...
                              <div class="form-validation-box">
                                ...
                                <%@taglib prefix= "f" uri= "http://www.springframework.org/tags/form" %>
                     		    ...
                     		    <f:form action= "updateStaff" modelAttribute="staffVO" method="post" enctype= "multipart/form-data">			
                                <div class="row">
                                <div class="col-md-6">
                                ...
                                <label class= "control-label">Photo</label>
                     			<input type= "file" name= "file" placeholder= "photo" class= "form-control" enctype= "multipart/form-data" required>
                     			</div>
								</div>
								</div>
