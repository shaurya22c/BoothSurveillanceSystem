                              ...
                              <table id="responsive_datatables_example" class="table display table-striped table-bordered responsive nowrap">
                                 ...
                                 <c:forEach items= "${staffList}" var= "z">
                                    <tr>
                                       ...
                                       <td>${z.firstName}</td>
                                       <td>${z.lastName}</td>
                                       <td>${z.email}</td>  <!--z.loginVO.email--> <!--staffvo getter setter of username, password to remove-->
                                       <td>${z.number}</td>
                                       <td><img src= "/document/demo/<c:url value= "${z.fileName}"/>"/></td>
                                       <!--  <td>${z.areaName}</td>
                                       <td>${z.cityName}</td>
                                       <td>${z.fileName}</td>
                                       <td>${z.filePath}</td>
                                        ...
                                        <td><a href="deleteStaff?id1=${z.staffId}">Delete</a></td>
                                        <td><a href="editStaff?id1=${z.staffId}">Edit</a></td>
