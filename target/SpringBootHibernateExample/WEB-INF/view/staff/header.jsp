                        ...
                        <ul class="nav nav-pills nav-top navbar-right">
                           ...
                           <li class="dropdown">
                              <a class="dropdown-toggle profile-toggle" href="#" data-toggle="dropdown">
                                 ...
                                 <!--<img src="<%=request.getContextPath()%>/adminResources/image/shaurya.jpg" class="profile-avator" alt="admin profile" />-->
                              ...
                              <div class="profile-box dropdown-menu animated bounceIn">
                                 <ul>
                                    ...
                                    <!--<li><a href="login"><i class="fa fa-power-off"></i> sign out</a></li>-->
