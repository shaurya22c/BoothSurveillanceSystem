...
<html>
 <head>
      ...
      <!-- Animate CSS -->
      <link rel="stylesheet" href="<%=request.getContextPath()%>/<%=request.getContextPath()%>/adminResources/css/animate.min.css">
      <!-- Bootstrap CSS -->
            ...
            <div class="page-content">
               <div class="container-fluid">
                  ...
                  <div class="row">
                              ...
                              <div class="form-validation-box">
                                 <div class="form-wrap">
                                    	<%@taglib prefix= "f" uri= "http://www.springframework.org/tags/form" %>
                     						<f:form action= "insertArea" modelAttribute="areaVO" method="post">
                                       <div class="row">
                                       <div class="col-md-12">
                     ...
                     <!--  <select placeholder="City" class="form-control" required>
					...
					<div class="row">
                                          ...
                                          <div class="col-md-12">
                                             <div class="form-group">
                                               ...
                                               <f:input type="text" placeholder="AreaName" class="form-control" path="areaName" required="required" />
                                             </div>
                                          </div>
                                          </div>
                                          <div class="row">
                                          <div class="col-md-12">
                                             <div class="form-group">
                                                ...
                                                <f:textarea placeholder="Your Present Address"  path = "areaDescription" class="form-control" required="required" ></f:textarea>
                                             </div>
                                          </div>
                                       </div>
					...
					<!--  <div class="col-md-6">
                                             <div class="form-group">
                    <input type="text" placeholder="Area" class="form-control" required >
					</div>
					</div>-->
