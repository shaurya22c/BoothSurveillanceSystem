               ...
               <div class="container-fluid">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        ...
                        <f:form action= "insertAllocate" modelAttribute="allocateVO" method="post">
                        ...
                        <div class="row">
                     	<div class="col-md-6">
                        <div class="form-group">
                        Starting Date:<f:input type="date" placeholder="Starting date" path= "startingDate" class="form-control" required= "required"/>
                        </div>
                        </div>
                        </div>
                        ...
                        <div class="row">
                     	<div class="col-md-6">
                        <div class="form-group">
                        End Date:<f:input type="date" placeholder="Ending date" path= "endingDate" class="form-control" required= "required"/>
                        </div>
                        </div>
                        </div>
                        <div class="row">
