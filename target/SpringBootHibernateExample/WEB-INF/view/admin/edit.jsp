                           ...
                           <div class="form-example">
                              ...
                              <div class="form-validation-box">
                                 ...
                                 <%@taglib prefix="f" uri="http://www.springframework.org/tags/form" %>
                                    ...
                                    <f:form  action="updateCity" modelAttribute="data2" method="post">
                                       <div class="row">
                                 
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                <label class="control-label">Cityname:</label>
                                               <f:input type="text" placeholder="CityName" class="form-control" path="cityName" required="required" />
                                             </div>
                                          </div>
                                          </div>
                                          <div class="row">
                                          <div class="col-md-12">
                                             <div class="form-group">
                                                ...
                                                <f:textarea placeholder="Your Present Address"  path = "cityDescription" class="form-control" required="required" ></f:textarea>
                                             </div>
                                          </div>
                                       </div>
