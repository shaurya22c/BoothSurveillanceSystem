                           ...
                           <div class="form-example">
                              ...
                              <div class="form-validation-box">
                                 ...
                                 <%@taglib prefix= "f" uri= "http://www.springframework.org/tags/form" %>
                                    <f:form action="updateBooth" modelAttribute="boothVO" method= "post">
                                       ...
                                       <div class="col-md-6">
										...
										<div class="row">
                                          ...
                                          <div class="col-md-6">
                     						...
                     						<f:select path="CityVO.cityId" class= "form-control">
