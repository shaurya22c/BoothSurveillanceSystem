                        ...
                        <div class="page-box">
                           ...
                           <div class="advance-table">
                              <table id="responsive_datatables_example" class="table display table-striped table-bordered responsive nowrap">
                                 ...
                                 <c:forEach items= "${allocateList}" var= "z">
                                    <tr>
                                       <td>${z.allocateId}</td>
                                       <td>${z.endingDate}</td>
                                       <td>${z.startingDate}</td>
                                       <td>${z.boothVO.boothId}</td>
                                       <td>${z.staffVO.firstName}</td>
                                       <td><a href="editAllocate?id1=${z.allocateId}">Edit</a></td>
										<td><a href="deleteAllocate?id1=${z.allocateId}">Delete</a></td>
