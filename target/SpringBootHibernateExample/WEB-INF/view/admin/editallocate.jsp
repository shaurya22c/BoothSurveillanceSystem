               ...
               <div class="container-fluid">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        ...
                        <f:form action= "updateAllocate" modelAttribute="allocateVO" method="post">
                        
                        <div class="row">
                     	<div class="col-md-6">
                        <div class="form-group">                       
                        Boothno:<f:select placeholder="Boothno" class="form-control" required= "required" path="BoothVO.boothId">			
                     	<f:options items= "${boothList}" itemLabel="boothNo" itemValue= "boothId"/>
                     	</f:select>
                        </div>
                        </div>
                        </div>
                        ...
                        <div class="row">
                     	<div class="col-md-6">
                        <div class="form-group">
                        Officername:<f:select placeholder="Officername" class="form-control" required= "required" path="StaffVO.staffId">			
                     	<f:options items= "${staffList}" itemLabel="firstName" itemValue= "staffId"/>
                     	</f:select>
                        </div>
                        </div>
                        </div>
                        ...
                        <div class="row">
                     	<div class="col-md-6">
                        <div class="form-group">
                        <f:input type="date" placeholder="Starting date" path= "startingDate" class="form-control" required= "required"/>
                        </div>
                        </div>
                        </div>
                        ...
                        <div class="row">
                     	<div class="col-md-6">
                        <div class="form-group">
                        <f:input type="date" placeholder="Ending date" path= "endingDate" class="form-control" required= "required"/>
                        </div>
                        </div>
                        </div>
                        <div class="row">
